...
RINIAPI bool rini_load(rini_data& data, const char *file_name ); //XXTH
...
RINIAPI bool rini_save(rini_data data, const char *file_name); // Save data to file, with custom header, XXTH bool
...
bool rini_load(rini_data& data, const char *file_name )
{
...
bool rini_save(rini_data data, const char *file_name)
{
